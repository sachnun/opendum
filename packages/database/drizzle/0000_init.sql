...
CREATE TABLE "provider_account" (
	...
	"lastRecoveredByRotationAt" timestamp,
...
CREATE TABLE "provider_account_model_health" (
	...
	"lastErrorCode" integer,
	"lastSuccessAt" timestamp,
	"unhealthyCountUpdatedAt" timestamp,
	"createdAt" timestamp DEFAULT now() NOT NULL,
	"updatedAt" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
CREATE TABLE "proxy_api_key" (
	...
	"roamingEnabled" boolean DEFAULT false NOT NULL,
	"isActive" boolean DEFAULT true NOT NULL,
	"expiresAt" timestamp,
	"lastUsedAt" timestamp,
	"createdAt" timestamp DEFAULT now() NOT NULL,
...
ALTER TABLE "point_transaction" ADD CONSTRAINT "point_transaction_usageLogId_usage_log_id_fk" FOREIGN KEY ("usageLogId") REFERENCES "public"."usage_log"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_point_balance" ADD CONSTRAINT "user_point_balance_userId_user_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_sharing_setting" ADD CONSTRAINT "user_sharing_setting_userId_user_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "point_transaction_idempotencyKey_key" ON "point_transaction" USING btree ("idempotencyKey");--> statement-breakpoint
CREATE INDEX "point_transaction_userId_createdAt_idx" ON "point_transaction" USING btree ("userId","createdAt");--> statement-breakpoint
CREATE INDEX "point_transaction_usageLogId_idx" ON "point_transaction" USING btree ("usageLogId");--> statement-breakpoint
