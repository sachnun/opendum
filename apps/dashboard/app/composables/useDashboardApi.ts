...
export function useDashboardApi() {
  ...
  return {
    ...
    accounts: {
      ...
      getAuthUrl: (body: { provider: "antigravity" | "codex" | "kiro" | "perch" }) => post<ActionResult<{ authUrl: string; state: string | null; codeVerifier: string | null }>>(dashboardFetch, "/api/dashboard/accounts/oauth/url", body),
      exchangeOAuth: (body: { provider: "antigravity" | "codex" | "kiro" | "perch"; callbackUrl: string; state?: string | null; codeVerifier?: string | null }) => post<ActionResult<{ email: string; isUpdate: boolean }>>(dashboardFetch, "/api/dashboard/accounts/oauth/exchange", body),
