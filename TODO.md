...
- [x] Port 18 Go test files → vitest (attempts, load_balancer, quota, token_refresher, routes_messages, providers, auth, registry, sessionaffinity, internal) — 180 tests green
